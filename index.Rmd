...
subtitle: "Universität Bern, Switzerland  (ICSTLL 58)"
...
- Hmong communities in the US speak White and Green Hmong, mostly immigrated from Laos

- words are monosyllabic (almost always without consonant coda)

- in the orthography used here (RPA) the final letter of the word corresponds to a tone

- 7 tones: high rising, high falling, mid, low, mid-rising, low-falling creaky, mid/high-falling breathy
...
```{r, fig.retina=1, out.width="40%", out.height="25%", dpi=900, echo=FALSE}
...
```{r, fig.retina=1, out.width="55%", out.height="auto", dpi=900, echo=FALSE}
...
```{r, fig.retina=1, out.width="95%", out.height="auto", dpi=900, echo=FALSE}
...
.pull-left[
```{r, fig.retina=1, out.width="100%", out.height="120%", dpi=900, echo=FALSE}
...
```{r, fig.retina=1, out.width="120%", out.height="120%", dpi=900, echo=FALSE}
...
```{r, fig.retina=1, out.width="50%", out.height="auto", dpi=900, echo=FALSE}
...
```{r, fig.retina=1, out.width="75%", out.height="auto", dpi=900, echo=FALSE}
knitr::include_graphics("./images/pl_contexts.png")
```
--
```{r, fig.retina=1, out.width="90%", out.height="auto", dpi=900, echo=FALSE}
...
.pull-left[
```{r, fig.retina=1, out.width="100%", out.height="100%", dpi=900, echo=FALSE}
...
```{r, fig.retina=1, out.width="120%", out.height="auto", dpi=900, echo=FALSE}
